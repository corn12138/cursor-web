import { ArchiveX } from "lucide-react"; // 👈 Import the icon
...
export const CommentsList = ({ discussionId }: CommentsListProps) => {
    const user = useUser();
    const commentsQuery = useInfiniteComments({ discussionId }); // 评论查询
    ...
    const comments = commentsQuery.data?.pages.flatMap((page) => page.data); // 评论
                        ...
                        >
                            ...
                            >
                                <div className="flex justify-between">
                                    ...
                                    <DeleteComment
                                        id={comment.id}
                                        discussionId={discussionId}></DeleteComment>
                                </div>
                            </Authorization>
